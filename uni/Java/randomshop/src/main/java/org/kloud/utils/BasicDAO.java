...
public abstract class BasicDAO<T extends BaseModel> {
    ...
    public abstract boolean addOrUpdateObject(@NotNull T product);

    public abstract boolean removeObject(@NotNull T product);

    public boolean isLatestVersionSaved() {
        Logger.debug("isLatestVersionSaved for " + getClass().getSimpleName() + ": " + lastSavedHash + ", " + objects.hashCode());
