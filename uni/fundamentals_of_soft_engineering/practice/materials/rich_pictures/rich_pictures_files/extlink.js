...
function extlinkAttach(context) {
  ...
  $("a:not(." + Drupal.settings.extlink.extClass + ", ." + Drupal.settings.extlink.mailtoClass + "), area:not(." + Drupal.settings.extlink.extClass + ", ." + Drupal.settings.extlink.mailtoClass + ")", context).each(function(el) {
    ...
    // <a href="http://web.archive.org/web/20221125150431/http://user:pass@example.com">example</a> User:pass syntax.
    catch(error) {
      return false;
    }
  });
...
/*
     FILE ARCHIVED ON 15:04:31 Nov 25, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:44:04 Oct 07, 2024.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 5.355
  LoadShardBlock: 38.87 (3)
  PetaboxLoader3.datanode: 105.268 (5)
  load_resource: 258.597 (2)
  PetaboxLoader3.resolve: 184.292 (2)
*/